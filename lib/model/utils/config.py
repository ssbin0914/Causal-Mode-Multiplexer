...
# __C.TRAIN.SCALES = (471,)  # CVC-14

# Max pixel size of the longest side of a scaled input image
__C.TRAIN.MAX_SIZE = 640 #640 #1000

# Trim size for input images to create minibatch
__C.TRAIN.TRIM_HEIGHT = 512
__C.TRAIN.TRIM_WIDTH = 512
# __C.TRAIN.TRIM_HEIGHT = 471  # CVC-14
# __C.TRAIN.TRIM_WIDTH = 471  # CVC-14
...
# __C.TEST.RPN_POST_NMS_TOP_N = 4000  # best
