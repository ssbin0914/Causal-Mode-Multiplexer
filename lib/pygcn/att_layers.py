...
class GraphAttentionLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, dropout, alpha, concat=True):
        ...
        self.alpha = alpha
        self.concat = concat
        self.t = 0.0 #Variable(torch.FloatTensor([0.0])).cuda()
    ...
    def forward(self, batch_size, input, adj):
        ...
        adj_non_zero = ((adj > self.t) * 1.0).type(torch.cuda.FloatTensor).detach()

        attention = e * adj_non_zero + 1e-5
